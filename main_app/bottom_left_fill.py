...
from .packing import PackingUtil,NFPAssistant
from .nfp import NFP
...
class BottomLeftFill(object):
    ...
    def showAll(self):
        ...
        # Configure the plot size and other settings using PltFunc.showPlt
        #PltFunc.showPlt(width=max(length, self.width), height=max(length, self.width), minus=100)
        
        # Define the processed image name and path
        processed_image_path = 'main_app\static\images\Figure_2.png'
